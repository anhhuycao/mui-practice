...
const unSeenNotifications = notificationList.filter((el) => el.status === 'unseen');
...
const Notifications = (props) => {
    ...
    return (
        <>
            <IconButton aria-controls='notifications' aria-haspopup='true' onClick={props.onOpen}>
            ...
            >
                ...
                <Typography variant='button' component='h4' className={classes.listHeader}>
                    NEW
                </Typography>
                    ...
                    <MenuItemUnseenStyle key={el.id}>
                        ...
                        <Box>
                            <Typography variant='body2' component='p'>
                                <strong>{el.mainText}</strong> <span className={classes.grayMain}>{el.subText}</span>
                            </Typography>
