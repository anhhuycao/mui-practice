import { Button, Drawer, MenuItem, TextField, Typography } from '@material-ui/core';
...
const ProductActionBar = () => {
    ...
    return (
        ...
        >
            ...
            {/* Drawer */}
            <Drawer anchor='right' variant='temporary' open={showDrawer} onClose={toggleDrawer}>
            ...
            <ButtonStyle>
                ...
                <TextFieldStyle variant='outlined' id='selectSort' className='selectSort' select value='newest'>
